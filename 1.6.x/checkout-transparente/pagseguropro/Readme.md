...
![](https://prestabr.com.br/docpagseguropro/img01.jpg "Instalação - Módulo PagSeguroPro")

## Configuração

---
#### 1 - Ativação, E-mail & Token

A Ativação, E-mail & Token são os primeiros passos para tornar a sua integração funcional. Após se cadastrar e formalizar a contratação do serviço junto ao PagSeguro você receberá um Token que será utilizado para referenciar a sua conta e validar os pedidos processados.

Com os dados em mãos basta marcar a opção Ambiente de Produção como SIM e em seguida copiar e colar o seu E-mail de cadastro e o seu Token nos campos indicados abaixo.

![](https://prestabr.com.br/docpagseguropro/img02.jpg "Configuração - Ativação, E-mail & Token - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img03.jpg "Configuração - Opções de Pagamento - Cartão de Crédito - Módulo PagSeguroPro")

- Boleto Bancário

![](https://prestabr.com.br/docpagseguropro/img04.jpg "Configuração - Opções de Pagamento - Boleto Bancário - Módulo PagSeguroPro")

- Débito Online 

![](https://prestabr.com.br/docpagseguropro/img05.jpg "Configuração - Opções de Pagamento - Débito online - Módulo PagSeguroPro")

Para selecionar dois ou mais meios de pagamentos pressione CTRL e clique na opção desejada:

![](https://prestabr.com.br/docpagseguropro/img06.jpg "Configuração - Opções de Pagamento - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img07.jpg "Configuração - Status de Pedido - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img08.jpg "Configuração - Parcelamento - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img09.jpg "Configuração - Desconto no Boleto Bancário - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img10.jpg "Configuração - Debug para soluçoes de problemas - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/print-debug.jpg "Configuração - Debug para soluçoes de problemas - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img11.jpg "Configuração - Registro & Gerenciamento de Logs - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img12.jpg "Configuração - Registro & Gerenciamento de Logs - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img13.jpg "Configuração - Registro & Gerenciamento de Logs - Módulo PagSeguroPro")
...
![](https://prestabr.com.br/docpagseguropro/img14.jpg "Configuração - Limpeza do Banco de Dados - Módulo PagSeguroPro")
