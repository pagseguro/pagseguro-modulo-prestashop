...
class PagSeguroProValidationModuleFrontController extends ModuleFrontController 
{
    ...
    {
		$pagseguro_msg = $this->module->l('Pagamento não autorizado. Algum dado pode estar incorreto ou ocorreu algum problema com a operadora. <br>Por favor, revise seus dados de pagamento e tente novamente.');
	 ...
	 * Redireciona o usuário para o carrinho novamente para retentativa
	 */
    private function retornoErroApi($transacao)
    {
		$pagseguro_msg = $this->module->l('Ocorreu um erro no processamento do seu pedido. Por favor, verifique se recebe um e-mail do PagSeguro sobre sua compra nos próximos minutos. <br>Caso contrário, por favor, tente finalizar a compra novamente.');
