...
<div class="panel">
   ...
   <div class="payment_options row">
      <div class="col-lg-10 col-lg-offset-1 col-xs-12 clearfix nopadding-left">
         <div class="panel panel-info clearfix">
            <div class="panel-heading" align="center">{l s='Aceite todas as Bandeiras - Cartão de Crédito, Boleto e Transferência Bancária' mod='pagseguropro'}</div>
   ...
   <div class="row itens">
      <div class="links" align="center">
         <ul class="list list-inline">
            <li>
               <a class="btn btn-primary" href="https://github.com/pagseguro/pagseguro-modulo-prestashop/tree/master/1.6.x/checkout-transparente/pagseguropro" target="_blank">{l s='Documentação do Módulo' mod='pagseguropro'}</a>
            </li>
            <li>
