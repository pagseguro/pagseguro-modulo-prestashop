			...
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					...
					<ul class="list list-unstyled">
						...
						<li><b>{l s='Forma de Pagamento:' mod='pagseguropro'}</b> <span>{$formaPagamento} ({$tipoPagamento})</span></li>
						<li><b>{l s='Link para pagamento:' mod='pagseguropro'}</b> <span>{$transaction->paymentLink}</span></li>
