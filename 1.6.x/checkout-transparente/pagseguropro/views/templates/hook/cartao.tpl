	...
	<fieldset class="pagamento col-xs-12 col-sm-6 pull-left">
		<div class="form-group clearfix row text-left" align="center">
			...
			<div class="input-group col-xs-12">
				<input name="card_name" data-validate="isName" class="form-control" type="text" id="card_name" value="{if (isset($senderName) && $senderName)}{$senderName}{/if}" size="30" onblur="sendToCard(this.value, 'card-name');checkField(this.id);" required />
			</div>
		</div>
		<div class="form-group clearfix row text-left" align="center">
		...
		<div class="form-group clearfix row text-left" align="center">
			...
			<div class="input-group col-xs-12">
				<input id="card_birth" class="form-control" name="card_birth" {if $device == 'm'}type="tel"{else}type="text"{/if} onkeypress="mascara(this,data)" maxlength="10" placeholder="{l s='DD/MM/AAAA' mod='pagseguropro'}" value="{if (isset($birthday) && $birthday)}{$birthday}{/if}" onblur="checkField(this.id);" required />
			</div>
		</div>
		<div class="form-group clearfix row text-left" align="center">
			<label class="text-left col-xs-12" for="card_phone">{l s='Telefone de contato:' mod='pagseguropro'}</label>
			<div class="input-group col-xs-12">
				<input id="card_phone" class="form-control" name="card_phone" {if $device == 'm'}type="tel"{else}type="text"{/if} maxlength="15" onkeypress="mascara(this,telefone)" onblur="validarTel('card_phone');$('#boleto_phone, #transf_phone').val(this.value);mascara(this,telefone);checkField(this.id);" value="{if (isset($phone) && $phone)}{$phone}{/if}" placeholder="(99) 99999-9999" required />
			</div>
		</div>
		<div class="form-group clearfix row text-left" align="center">
