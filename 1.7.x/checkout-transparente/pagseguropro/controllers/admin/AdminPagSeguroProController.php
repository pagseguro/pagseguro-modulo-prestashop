...
class AdminPagSeguroProController extends ModuleAdminController
{
	...
	{        
        ...
        $this->fields_list = array(
            ...
            'refund' => array(
                'title' => $this->module->l('Estorno', 'AdminPagSeguroPro'),
                'align' => 'left',
                'width' => 80,
				'filter_key' => 'a!refund',
            ),
    ...
    public function renderView()
    {
		...
		if (isset($info['credencial']) && $info['credencial'] != '' && isset($info['token_codigo']) && $info['token_codigo'] != ''){
	        $transaction = $pagseguro->getTransaction($info['cod_transacao'], $info['credencial'], $info['token_codigo'], $id_cart);
		}else{
	        $transaction = $pagseguro->getTransaction($info['cod_transacao'], false, false, $id_cart);
		}
