...
class PagSeguroPro extends PaymentModule
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('PAGSEGUROPRO_PARCELA_MINIMA', '1.00');
    ...
    public function getContent()
    {
		...
		$url_country  = 'index.php?controller=AdminCountries&id_country=58&updatecountry&token='.Tools::getAdminTokenLite('AdminCountries');

		$this->context->smarty->assign(array(
			'states_warning' => $country->contains_states,
    ...
    protected function getConfigForm()
    {
		...
		{
			$texto_sandbox .= '<br><div class="alert alert-danger"><p>'.$this->trans('O ambiente Sandbox tem o Token diferente do ambiente de Produção.', array(), 'Modules.PagSeguroPro.Admin').'</p>';
			$texto_sandbox .= '<p>'.$this->trans('Gere o token aqui:', array(), 'Modules.PagSeguroPro.Admin').' <a href="https://sandbox.pagseguro.uol.com.br/" target="_blank">https://sandbox.pagseguro.uol.com.br</a></p></div>';
		}
		$link_order_preferences = 'index.php?controller=AdminOrderPreferences&token='.Tools::getAdminTokenLite('AdminOrderPreferences');
		$texto_parcela_minima = '<br />'.$this->trans('Em complemento, se preferir, você pode ativar a opção para restringir o valor mínimo de pedido aceito pela loja. Tab Preferências > Pedidos ou', array(), 'Modules.PagSeguroPro.Admin').' <a href="'.$link_order_preferences.'">'.$this->trans('clicando aqui', array(), 'Modules.PagSeguroPro.Admin').'</a>.';

        $fields_form_1 = array(
            'form' => array(
                'legend' => array(
				'title' => $this->trans('Ativação - TOKEN', array(), 'Modules.PagSeguroPro.Admin'),
                'icon' => 'icon-cogs',
                ),
                'input' => array(
                    array(
                        ...
                        'bool' => false,
                        'desc' => $this->trans('Você pode utilizar o Ambiente de Testes (Sandbox)  e testar tudo antes de colocar em Produção.', array(), 'Modules.PagSeguroPro.Admin').$texto_sandbox,
                        'values' => array(
                            array(
        ...
        $fields_form_2 = array(
            'form' => array(
                'legend' => array(
				'title' => $this->trans('Opções de Pagamento', array(), 'Modules.PagSeguroPro.Admin'),
                'icon' => 'icon-cogs',
                ),
                'input' => array(
					array(
						'type' => 'switch',
						'label' => $this->trans('Cartão de Crédito', array(), 'Modules.PagSeguroPro.Admin'),
						'name' => 'PAGSEGUROPRO_CARTAO',
						'bool' => false,
						'values' => array(
							array(
								'id' => 'PAGSEGUROPRO_CARTAO_on',
								'value' => 1,
								'label' => $this->trans('SIM', array(), 'Modules.PagSeguroPro.Admin'),
							) ,
							array(
								'id' => 'PAGSEGUROPRO_CARTAO_off',
								'value' => 0,
					...
					array(
						'type' => 'switch',
						'label' => $this->trans('Boleto Bancário', array(), 'Modules.PagSeguroPro.Admin'),
						'name' => 'PAGSEGUROPRO_BOLETO',
						'bool' => false,
						'values' => array(
							array(
								'id' => 'PAGSEGUROPRO_BOLETO_on',
								'value' => 1,
								'label' => $this->trans('SIM', array(), 'Modules.PagSeguroPro.Admin'),
							) ,
							array(
								'id' => 'PAGSEGUROPRO_BOLETO_off',
								'value' => 0,
								'label' => $this->trans('Não', array(), 'Modules.PagSeguroPro.Admin'),
							),
						),
					...
					array(
						'type' => 'switch',
						'label' => $this->trans('Transferência Bancária', array(), 'Modules.PagSeguroPro.Admin'),
						'name' => 'PAGSEGUROPRO_TRANSF',
						'bool' => false,
						...
						'values' => array(
							array(
								'id' => 'PAGSEGUROPRO_TRANSF_on',
								'value' => 1,
								'label' => $this->trans('SIM', array(), 'Modules.PagSeguroPro.Admin'),
							) ,
							array(
								'id' => 'PAGSEGUROPRO_TRANSF_off',
								'value' => 0,
								'label' => $this->trans('Não', array(), 'Modules.PagSeguroPro.Admin'),
							),
						),
        ...
        $fields_form_3 = array(
            'form' => array(
                'legend' => array(
				'title' => $this->trans('Configurações de Pagamento', array(), 'Modules.PagSeguroPro.Admin'),
                'icon' => 'icon-cogs',
                ),
                'input' => array(
                    array(
			...
			'class' => 'fixed-width-sm',
                    ...
                    array(
                        'type' => 'text',
						'class' => 'fixed-width-sm',
                        'label' => $this->trans('Valor da parcela mínima', array(), 'Modules.PagSeguroPro.Admin'),
                        'name' => 'PAGSEGUROPRO_PARCELA_MINIMA',
                        'desc' => $this->trans('Defina o valor da parcela mínima, exemplo: 5.00 ou 15.00. Deixe como 0 (zero) para desativar este recurso.', array(), 'Modules.PagSeguroPro.Admin'),
                    ),
					array(
				        'type' => 'radio',
				        'label' => $this->trans('Comportamento da parcela mínima', array(), 'Modules.PagSeguroPro.Admin'),
				        ...
				        'values' => array(
				            array(
				                'id' => 'opcao_1',
				                'value' => 0,
				                'label' => $this->trans('Não processar nada abaixo do valor mínimo estipulado.', array(), 'Modules.PagSeguroPro.Admin').$texto_parcela_minima
				            ),
				            array(
				                'id' => 'opcao_2',
				                'value' => 1,
				                'label' => $this->trans('Oferecer pagamento a vista, em 1x parcela, para valores abaixo do mínimo estipulado.', array(), 'Modules.PagSeguroPro.Admin')
				            ),
				        ),
				    ),
                    array(
                    ...
                    array(
                        ...
                        'desc' => $this->trans('Defina o valor do desconto, exemplo: 5.00 ou 15.00. Deixe como 0 (zero) para desativar este recurso.', array(), 'Modules.PagSeguroPro.Admin'),
                    ),
				),
			),
		);
        ...
        $fields_form_4 = array(
            'form' => array(
                'legend' => array(
				'title' => $this->trans('Status de Pedido - Mapeamento', array(), 'Modules.PagSeguroPro.Admin'),
                'icon' => 'icon-cogs',
                ),
                'input' => array(
                    array(
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->trans('Status de Pedido Estornado'),
        ...
        $fields_form_5 = array(
            'form' => array(
                'legend' => array(
				'title' => $this->trans('Debug & Logs', array(), 'Modules.PagSeguroPro.Admin'),
                'icon' => 'icon-cogs',
                ),
                'input' => array(
                    array(
        ...
        $fields_form_6 = array(
            'form' => array(
                'legend' => array(
				'title' => $this->trans('Salvar Configurações', array(), 'Modules.PagSeguroPro.Admin'),
                'icon' => 'icon-cogs',
                ),
                'submit' => array(
    ...
    protected function getConfigFormValues()
    {
        return array(
			...
			'PAGSEGUROPRO_CARTAO' => Tools::getValue('PAGSEGUROPRO_CARTAO', Configuration::get('PAGSEGUROPRO_CARTAO')),
			'PAGSEGUROPRO_BOLETO' => Tools::getValue('PAGSEGUROPRO_BOLETO', Configuration::get('PAGSEGUROPRO_BOLETO')),
			'PAGSEGUROPRO_TRANSF' => Tools::getValue('PAGSEGUROPRO_TRANSF', Configuration::get('PAGSEGUROPRO_TRANSF')),
	...
	*/
	...
	public function hookActionFrontControllerSetMedia($params)
	{
		...
		if ($this->context->controller->php_self === 'order') {
			...
			$this->context->controller->registerJavascript(
				'pagseguropro-purify', 
				'modules/'.$this->name.'/views/js/purify.min.js',
    ...
    public function hookPaymentOptions($params)
    {
		...
		$cartao = Configuration::get('PAGSEGUROPRO_CARTAO');
		$boleto = Configuration::get('PAGSEGUROPRO_BOLETO');
		$transf = Configuration::get('PAGSEGUROPRO_TRANSF');
		...
		if ($cartao){
			...
			$psOption->setModuleName($this->name)
				...
				->setAction($this->context->link->getModuleLink($this->name, 'validation', array('ptype' => 'cartao'), true))
		...
		if ($boleto){
			...
			$psOption->setModuleName($this->name)
				->setCallToActionText($payText)
				->setLogo($this->urls['img'].'logo_pagseguro_mini.png')
				->setAction($this->context->link->getModuleLink($this->name, 'validation', array('ptype' => 'boleto'), true))
				->setForm($this->fetch('module:pagseguropro/views/templates/hook/'.$payTpl));
			$payOptions[]= $psOption;
		}
		...
		if ($transf){
			...
			$payTpl = 'transferencia.tpl';
			$psOption = new PaymentOption();
			$psOption->setModuleName($this->name)
				->setCallToActionText($payText)
				->setLogo($this->urls['img'].'logo_pagseguro_mini.png')
				->setAction($this->context->link->getModuleLink($this->name, 'validation', array('ptype' => 'transf'), true))
				->setForm($this->fetch('module:pagseguropro/views/templates/hook/'.$payTpl));
			$payOptions[] = $psOption;
		}
    ...
    public function hookBackOfficeHeader()
    {
		...
		$get_address = Db::getInstance(_PS_USE_SQL_SLAVE_)->ExecuteS('SELECT `field_name` FROM `'._DB_PREFIX_.'required_field` WHERE `object_name`="CustomerAddress"');
		...
		if ($get_country->contains_states == 0 || empty($get_cpf) || $get_postcode == false || $get_address2 == false || empty($get_restr_carrier)) {
			$this->context->controller->warnings[] = '<p><b>Módulo Oficial PagSeguro - Checkout Transparente - PS 1.7.x</b></p>';
		}
		...
		if (empty($get_restr_carrier)) {
			$this->context->controller->warnings[] = '<p>---</p> <p><b>Atenção - Restrições de transportadora: </b></p> <p>Verifique se as transportadoras estão vinculadas à forma de pagamento. Isso vai garantir que o módulo seja exibido e esteja disponível para processar pagamentos na tela de checkout.</p> <p>Ver as configurações de Restrições de transportadora: <a href="'.$set_url_restr_carrier.'">Clique aqui</a> (role até o final da página)</p>';
		}
    }
