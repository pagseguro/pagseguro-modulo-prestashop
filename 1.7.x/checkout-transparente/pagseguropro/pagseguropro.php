    ...
    protected function getConfigForm()
    {
        ...
        return array(
			...
			'class' => 'fixed-width-xs',
                        ...
                        'desc' => $this->trans('Defina o valor da parcela mínima, exemplo: 15.00. Deixe com 0.00 para desativar este recurso.', array(), 'Modules.PagSeguroPro.Admin'),
                    ),
                    array(
                        'type' => 'select',
			...
			'class' => 'fixed-width-xs',
                        ...
                        'desc' => $this->trans('Defina o valor do desconto, exemplo: 15.00. Deixe com 0.00 para desativar este recurso.', array(), 'Modules.PagSeguroPro.Admin'),
                    ),
                    array(
                        'type' => 'switch',
