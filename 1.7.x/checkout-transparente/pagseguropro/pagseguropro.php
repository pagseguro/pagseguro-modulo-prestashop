...
class PagSeguroPro extends PaymentModule
{
	...
	Configuration::updateValue('PAGSEGUROPRO_ESTORNADO', PS_OS_REFUND);
    ...
    protected function getConfigFormValues()
    {
        ...
        return array(
            ...
            'PAGSEGUROPRO_ESTONADO' => Tools::getValue('PAGSEGUROPRO_ESTONADO', Configuration::get('PAGSEGUROPRO_ESTONADO')),
