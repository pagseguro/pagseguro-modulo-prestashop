...
class PagSeguroPro extends PaymentModule
{
    ...
    protected function getConfigForm()
    {
		...
		{
			$texto_sandbox .= '<br><div class="alert alert-danger"><p>'.$this->l('O ambiente Sandbox tem o Token diferente do ambiente de Produção.', array(), 'Modules.PagSeguroPro.Admin').'</p>';
			$texto_sandbox .= '<p>'.$this->l('Gere o token aqui:', array(), 'Modules.PagSeguroPro.Admin').' <a href="https://sandbox.pagseguro.uol.com.br/" target="_blank">https://sandbox.pagseguro.uol.com.br</a></p></div>';
		}
        return array(
            'form' => array(
                'legend' => array(
