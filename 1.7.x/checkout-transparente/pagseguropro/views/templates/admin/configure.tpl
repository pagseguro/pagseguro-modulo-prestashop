...
<div class="panel">
   ...
   <div class="payment_options row">
      <div class="col-lg-10 col-lg-offset-1 col-xs-12 clearfix nopadding-left">
         <div class="panel panel-info clearfix">
            <div class="panel-heading" align="center">{l s='Aceite todas as Bandeiras - Cartão de Crédito, Boleto e Transferência Bancária' d='Modules.PagSeguroPro.Admin'}</div>
            <div class="panel-body">
               <ul class="list list-inline">
                  ...
                  <li>
                     <span class="alelo brand-logo" title="Alelo">
                     {l s='Alelo' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="sodexo brand-logo" title="Sodexo">
                     {l s='Sodexo' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="ticket brand-logo" title="Ticket">
                     {l s='Ticket' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="vr brand-logo" title="VR">
                     {l s='VR' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="ben brand-logo" title="Ben">
                     {l s='Ben' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                  ...
                  <li>
                     <span class="plenocard brand-logo" title="Pleno Card">
                     {l s='Pleno Card' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="balance brand-logo" title="Balance">
                     {l s='Balance' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="cardban brand-logo" title="Card Ban">
                     {l s='Card Ban' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="prepaid-card brand-logo" title="Prepaid Card">
                     {l s='Pleno Card' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="redeshop brand-logo" title="Rede Shop">
                     {l s='Rede Shop' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="verdecard brand-logo" title="Verde Card">
                     {l s='Verde Card' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="policard brand-logo" title="Poli Card">
                     {l s='Poli Card' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
                     <span class="boleto brand-logo" title="Boleto Bancário">
                     {l s='Boleto Bancário' mod='pagseguropro'}
                     </span>
                  </li>
                  <li>
   ...
   <div class="row itens">
      <div class="links" align="center">
         <ul class="list list-inline">
            <li>
               <a class="btn btn-primary" href="https://github.com/pagseguro/pagseguro-modulo-prestashop/tree/master/1.7.x/checkout-transparente/pagseguropro" target="_blank">{l s='Documentação do Módulo' d='Modules.PagSeguroPro.Admin'}</a>
            </li>
            <li>
...
<div class="alert alert-danger">
	<p><b>{l s='Atenção:' mod='pagseguropro'}</b></p>
	<p>{l s='Para processar os pagamentos corretamente é preciso habilitar os estados (UF) nas configurações do país.' mod='pagseguropro'}</p>
	<p>{l s='Esta configuração exige que o cliente informe o seu estado durante o cadastro do endereço.' mod='pagseguropro'}</p>
	<p>{l s='Marque a opção' mod='pagseguropro'} <b>{l s='Contém estados' mod='pagseguropro'}</b> {l s='como SIM.' mod='pagseguropro'}</p>
	<p>{l s='Ver as configurações do país:' mod='pagseguropro'} <a href="{$url_country}">{l s='Clique aqui' mod='pagseguropro'}</a></p>
</div>
{/if}
