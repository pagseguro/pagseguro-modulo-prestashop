			...
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					...
					<ul class="list list-unstyled">
						...
						<li><b>{l s='Forma de Pagamento:' d='Modules.PagSeguroPro.Admin'}</b> <span>{$formaPagamento} ({$tipoPagamento})</span></li>
						<li><b>{l s='Link para pagamento:' d='Modules.PagSeguroPro.Admin'}</b> <span>{$transaction->paymentLink}</span></li>
