			...
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					...
					<ul class="list list-unstyled">
						...
						<li><b>{l s='Link para pagamento:' d='Modules.PagSeguroPro.Admin'}</b> <span>{if $transaction->paymentLink}<u><a href="{$transaction->paymentLink}" target="_blank">{l s='Visualizar Boleto' mod='pagseguropro'}</a></u>{else}--{/if}</span></li>
