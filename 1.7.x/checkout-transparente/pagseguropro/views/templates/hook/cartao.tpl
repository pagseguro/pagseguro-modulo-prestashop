		...
		<fieldset class="pagamento col-lg-6 col-md-12 col-sm-12 col-xs-12 pull-left nopadding-left">
			<div class="form-group clearfix row" align="center">
				...
				<div class="input-group col-xs-12">
					<input name="card_name" data-validate="isName" class="form-control" type="text" id="card_name" value="{if (isset($senderName) && $senderName)}{$senderName}{/if}" size="30" onBlur="sendToCard(this.value, 'card-name');checkField('card_name');ps_validarCartao(false);" required />
				</div>
			</div>
			<div class="form-group clearfix row" align="center">
			...
			<div class="form-group clearfix row" align="center">
				...
				<div class="input-group col-xs-12">
					<input id="card_birth" class="form-control" name="card_birth" {if $device == 'm'}type="tel"{else}type="text"{/if} onkeypress="mascara(this,data)" maxlength="10" placeholder="{l s='DD/MM/AAAA' d='Modules.PagSeguroPro.Shop'}" value="{if (isset($birthday) && $birthday)}{$birthday}{/if}" onBlur="ps_validarCartao(false);checkField('card_birth');" required />
				</div>
			</div>
			<div class="form-group clearfix row" align="center">
