...
class PagBankV8 extends Module
{
	...
	public function getConfigForm()
	{
		...
		$text_capture = '<br />Na captura manual (Pré-autorização) o pagamento só será debitado do cartão de crédito após ação manual no histórico do pedido. <br /> Veja mais informações na documentação <a href="https://github.com/pagseguro/pagseguro-modulo-prestashop?tab=readme-ov-file#3---configura%C3%A7%C3%B5es-de-pagamento" target="_blank">clicando aqui</a>.';
