...
class PagBankV8 extends Module
{
	...
	public function addStatus()
	{
		$os = array(
			...
			'3' => $this->module->trans('PagBank - Pagamento Autorizado', array(), 'Modules.PagBank.Admin')
		);
	...
	public function getConfigForm()
	{
		...
		if ($user_credential) {
			...
			$text_credential .= '<br /><div class="alert alert-info"><p>' . $this->module->trans('Se você trocou de ambiente, por favor, confira a credencial e salve novamente.', array(), 'Modules.PagBank.Admin') . '</div>';
		}
		...
		$fields_form_1 = array(
			'form' => array(
				'legend' => array(
					'title' =>  $this->module->trans('Pagamento via Cartão de Crédito', array(), 'Modules.PagBank.Admin'),
					'icon' => 'icon-cogs',
				),
				'input' => array(
					array(
					...
					array(
						...
						'is_bool' => true,
						'desc' =>  $this->module->trans('O cliente poderá salvar o Cartão de Crédito para futuras compras. 
						O Cartão é criptografado e armazenado pelo PagBank através do processo de Tokenização.', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
		...
		$fields_form_2 = array(
			'form' => array(
				'legend' => array(
					'title' =>  $this->module->trans('Pagamento via Cartão de Crédito com Google Pay', array(), 'Modules.PagBank.Admin'),
					'icon' => 'icon-cogs',
				),
				'input' => array(
					array(
						'type' => 'switch',
						'label' =>  $this->module->trans('Google Pay', array(), 'Modules.PagBank.Admin'),
					...
					array(
						...
						'is_bool' => true,
						'desc' =>  $this->module->trans('Você deve utilizar o Ambiente de Testes (Sandbox) para solicitar a aprovação da integração na sua conta junto ao Google.', array(), 'Modules.PagBank.Admin') . $text_sandbox_google,
						'values' => array(
							array(
					...
					array(
						'type' => 'switch',
						'label' =>  $this->module->trans('Pedido Demo?', array(), 'Modules.PagBank.Admin'),
						'name' => 'PAGBANK_GOOGLE_ORDER_DEMO',
						'is_bool' => true,
						'desc' =>  $this->module->trans('Permite criar pedido de demonstração, para solicitar a aprovação da integração na sua conta junto ao Google, enquanto a sua loja está trabalhando em modo de Produção com outras formas de pagamento.', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
		...
		$fields_form_3 = array(
			'form' => array(
				'legend' => array(
					'title' =>  $this->module->trans('Configurações de Pagamento via Cartão de Crédito', array(), 'Modules.PagBank.Admin'),
					'icon' => 'icon-cogs',
				),
				'input' => array(
					array(
					...
					array(
						'type' => 'switch',
						'label' =>  $this->module->trans('Tipo de Captura', array(), 'Modules.PagBank.Admin'),
						'name' => 'PAGBANK_CAPTURE_METHOD',
						'is_bool' => true,
						'desc' =>  $this->module->trans('Na captura automática o pagamento é debitado imeditamente do cartão de crédito.', array(), 'Modules.PagBank.Admin') . $text_capture,
						'values' => array(
							array(
								'id' => 'PAGBANK_CAPTURE_METHOD_on',
								'value' => 1,
								'label' =>  $this->module->trans('Automática', array(), 'Modules.PagBank.Admin'),
							),
							array(
								'id' => 'PAGBANK_CAPTURE_METHOD_off',
								'value' => 0,
								'label' =>  $this->module->trans('Manual', array(), 'Modules.PagBank.Admin'),
							),
						),
					),
				),
		...
		$fields_form_4 = array(
			'form' => array(
				'legend' => array(
					'title' =>  $this->module->trans('Pagamento via PIX', array(), 'Modules.PagBank.Admin'),
					'icon' => 'icon-cogs',
				),
				'input' => array(
					array(
						...
						'desc' =>  $this->module->trans('Atenção: Não esqueça de cadastrar uma chave PIX no super app PagBank', array(), 'Modules.PagBank.Admin'),
					),
					array(
						'type' => 'text',
						'class' => 'fixed-width-xs fixed-width-sm',
		...
		$fields_form_5 = array(
			'form' => array(
				'legend' => array(
					'title' =>  $this->module->trans('Pagamento via Boleto Bancário', array(), 'Modules.PagBank.Admin'),
					'icon' => 'icon-cogs',
				),
				'input' => array(
					array(
		...
		$fields_form_6 = array(
			'form' => array(
				'legend' => array(
					'title' =>  $this->module->trans('Pagamento via Pagar com PagBank (Wallet)', array(), 'Modules.PagBank.Admin'),
					'icon' => 'icon-cogs',
				),
				'input' => array(
					array(
						'type' => 'switch',
						'label' =>  $this->module->trans('Pagar com PagBank', array(), 'Modules.PagBank.Admin'),
						'name' => 'PAGBANK_WALLET',
						'is_bool' => true,
						'desc' =>  $this->module->trans('Pagamento com saldo ou cartão de crédito cadastrado no super app PagBank', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
		...
		$fields_form_7 = array(
			'form' => array(
				'legend' => array(
					'title' =>  $this->module->trans('Opções de Descontos', array(), 'Modules.PagBank.Admin'),
					'icon' => 'icon-cogs',
				),
				'input' => array(
					array(
					...
					array(
						...
						'is_bool' => true,
						'desc' =>  $this->module->trans('Atenção: O valor mínimo da transação via Boleto Bancário é de R$ 1.00.', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
					...
					array(
						...
						'is_bool' => true,
						'desc' =>  $this->module->trans('Atenção: O valor mínimo da transação via Pix é de R$ 1.00.', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
					...
					array(
						'type' => 'switch',
						'label' =>  $this->module->trans('Desconto no Google Pay (1x)', array(), 'Modules.PagBank.Admin'),
						'name' => 'PAGBANK_DISCOUNT_GOOGLE',
						'is_bool' => true,
						'desc' =>  $this->module->trans('Atenção: O valor mínimo da transação via Google Pay é de R$ 1.00.', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
		...
		$fields_form_8 = array(
			'form' => array(
				...
				'input' => array(
					array(
						'type' => 'select',
						'label' =>  $this->module->trans('Status de Pagamento Aceito', array(), 'Modules.PagBank.Admin'),
						'name' => 'PAGBANK_PAID',
						'desc' =>  $this->module->trans('Defina o Status que sua loja utiliza como \"Pagamento Aceito\".', array(), 'Modules.PagBank.Admin'),
						'options' => array(
							'query' => $statuses,
							'id' => 'id_order_state',
							'name' => 'name',
		...
		$fields_form_9 = array(
			'form' => array(
				...
				'input' => array(
					array(
						'type' => 'switch',
						'label' =>  $this->module->trans('Desativar aviso Cron?', array(), 'Modules.PagBank.Admin'),
						'name' => 'PAGBANK_CRON_WARNING',
						'is_bool' => true,
						'desc' =>  $this->module->trans('Exibe informativo sobre a configuração da Tarefa Cron.', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
								'id' => 'cron_on',
								'value' => 1,
					...
					array(
						...
						'is_bool' => true,
						'desc' =>  $this->module->trans('Mostrar mensagens do JavaScript no console do navegador para fins de depuração no checkout.', array(), 'Modules.PagBank.Admin'),
						'values' => array(
							array(
								'id' => 'console_on',
								'value' => 1,
