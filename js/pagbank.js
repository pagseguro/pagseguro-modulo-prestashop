...
function checkField(field_id) {
	...
	var bankslip_form = $('#bankslip_pagbank');
	var pix_form = $('#pix_pagbank');
	var ps_card_number_invoice = document.getElementById('ps_card_number_invoice');
	var ps_bankslip_number_invoice = document.getElementById('ps_bankslip_number_invoice');
	var ps_pix_number_invoice = document.getElementById('ps_pix_number_invoice');
	var ps_card_state_invoice = document.getElementById('ps_card_state_invoice');
	var ps_bankslip_state_invoice = document.getElementById('ps_bankslip_state_invoice');
	var ps_pix_state_invoice = document.getElementById('ps_pix_state_invoice');
