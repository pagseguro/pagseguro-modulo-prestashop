	...
	*/
	public function checkForUpdates()
	{
		...
		if($this->version < $file_version){
			$this->context->controller->warnings[] = '<p><b>Módulo PagBank - Atualização disponível (v.'.$file_version.')! Acesse: <a href="https://github.com/pagseguro/pagseguro-modulo-prestashop" target="_blank">https://github.com/pagseguro/pagseguro-modulo-prestashop</a> </b></p>';
		}
	}
}
