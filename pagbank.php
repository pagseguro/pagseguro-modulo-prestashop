...
class PagBank extends PaymentModule
{
	...
	*/
	...
	{
		$delete_query = 'DELETE FROM `' . _DB_PREFIX_ . 'pagbank_customer_token` WHERE (`id_shop` = ' . (int)$this->shop_id . ' OR `id_shop` IS NULL) AND `id_customer_token` = ' . (int)$id_customer_token;
