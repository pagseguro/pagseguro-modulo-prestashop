...
abstract class PagSeguroController
{
    ...
    public abstract function doInstall();

    public abstract function doUnistall();

    public abstract function configPayment($params);

    public abstract function configReturnPayment($params);
}