...
class PagSeguroModulo14 extends PaymentModule {
	...
	$payment = version_compare(_PS_VERSION_, '1.5.0.1', '>=') ? _PS_BASE_URL_ . __PS_BASE_URI__ . 'modules/pagseguro/payment.php' :
		$link->getPageLink('modules/pagseguro/payment.php');
    ...
    public function execPagError()
    {
        ...
        $this->context->smarty->assign(array(
            '$erro_image' => $this->_path . 'assets/images/logops_86x49.png'));
