...
<h2 class="title" title="Estorno">Estorno</h2>
<p>
...
{if isset($hasCredentials) && $hasCredentials}
    ...
    <div class="pagseguro-search-tools">
       <button class="pagseguro-button" type="button" id="refund-search-button">Pesquisar</button>
        <select class="pagseguro-field" id="pagseguro-refund-days-input" name="pagseguro_dias">
            {html_options values=$searchValues output=$searchValues}
        </select>
        <span>&nbsp;últimos dias</span>
    </div>
    
    <table id="refund-table" class="pagseguro-table" cellspacing="0" width="100%">
        <thead>
            <tr>
