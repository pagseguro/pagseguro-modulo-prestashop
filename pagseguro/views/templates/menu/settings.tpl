...
<label>TOKEN*</label>
<br>
    <input type="text" name="pagseguro_token" id="pagseguro_token" value="{$token}" maxlength="32" hint="Para utilizar qualquer serviço de integração do PagSeguro, é necessário ter um token de segurança. O token é um código único, gerado pelo PagSeguro. Caso não tenha um token &lt;a href=&quot;https://pagseguro.uol.com.br/integracao/token-de-seguranca.jhtml&quot; target=&quot;_blank&quot;&gt; clique aqui &lt;/a&gt;, para gerar." onchange="validarForm('pagseguro_token')">
<br>
<label>CHARSET</label>
<br>
