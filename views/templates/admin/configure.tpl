	...
	<div class="row">
		<div class="links" align="center">
			<ul class="list list-inline">
				<li>
					<a class="btn btn-primary" href="https://github.com/pagbank/pagbank-modulo-prestashop"
						target="_blank">{l s='Documentação do Módulo' mod='pagbank'}</a>
				</li>
				<li>
					<a class="btn btn-primary" href="https://github.com/pagbank/pagbank-modulo-prestashop/issues"
		...
		<div id="collapseCron" class="collapse" data-parent="#accordionCron">
			<div class="info-cron">
				...
				<p>
					<b>{l s='-' mod='pagbank'}</b>
					{l s='O cancelamento do Boleto e Pix via Tarefa Cron é útil para o seu gerenciamento de estoque, se o pedido não for pago dentro do prazo estipulado.' mod='pagbank'}<br />
					<b>{l s='-' mod='pagbank'}</b>
		...
		<div class="allapps col-xs-12 col-sm-12">
			...
			<div id="app-steps" class="col-xs-12 col-sm-12" align="center">
				...
				<div class="col-xs-12 col-sm-6 info-app pull-right">
					<div {if ($ps_version >= '1.7')}class="accordion ps18" {else}class="accordion ps16" {/if}
						id="accordionApp">
						<div class="card">
