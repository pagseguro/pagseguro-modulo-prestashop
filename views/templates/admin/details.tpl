		...
		<div class="row">
			<div class="panel card col-xs-12 col-sm-6">
				<div class="alert alert-info">
						<p>{l s='Pedido Demo Google Pay.' mod='pagbank'} <br/>
						{l s='ID Pedido Loja:' mod='pagbank'} {$info.id_order}</p>
				</div>
			</div>
		</div>
	</div>
	...
	{if $info.refund > 0}
		<div class="alert alert-info">
			<p>{l s='Pedido com estorno Parcial ou Total no PagBank. Valor do último estorno: R$' mod='pagbank'}
				{$info.refund}.</p>
			<p>{l s='Para mais detalhes acesse a sua conta no PagBank, no menu, "Extratos e Relatórios".' mod='pagbank'}
			</p>
