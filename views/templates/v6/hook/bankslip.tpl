...
<div class="container-bankslip clearfix">
	<form id="bankslip_pagbank" name="checkout"
		...
		<div class="logo-bankslip col-xs-12 col-sm-6 clearfix" align="center">
		...
		{if isset($discount_value) && ($discounts.discount_type > 0 && $discounts.discount_value > 0) && $discounts.bankslip}
