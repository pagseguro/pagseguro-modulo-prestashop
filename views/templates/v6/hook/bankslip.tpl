...
<div class="container-bankslip clearfix">
	<div id="pagbank_bankslip_error" class="col-xs-10 col-sm-10 col-lg-9 text-center nofloat-block" style="display:none;"></div>
	<form id="bankslip_pagbank" method="post" target="_top" action="{$link->getModuleLink('pagbank', 'validation', [], true)|escape:'html'}" 
	class="clearfix">
		...
		<div class="right-side col-xs-12 col-sm-12 col-lg-6 pull-right">
			<div {if $device == 'm'}class="logo-bankslip-mob"{else}class="logo-bankslip"{/if} align="center">
				<br /><img title="Boleto Bancário" src="{$img_path}boleto.png" alt="{l s='Boleto Bancário' mod='pagbank'}"
		...
		<div class="form-group clearfix col-xs-12 col-sm-12 col-lg-12 collapse" id="bankslip_address">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-lg-6 pull-left">
					<div class="form-group">
						...
						<input id="bankslip_postcode_invoice" class="form-control" name="postcode_invoice" type="text"
							onblur="psValidateBankslip();" autocomplete="off" maxlength="9"
