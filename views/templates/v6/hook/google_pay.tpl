...
<div class="container-google clearfix">
	<div id="pagbank_google_error" class="col-xs-10 col-sm-9 text-center nofloat-block" style="display:none;"></div>
	...
	onsubmit="showLoading();" class="clearfix">
		...
		<div class="form-group clearfix col-xs-12 col-sm-12 collapse" id="google_address">
			<div class="row">
				<div class="col-xs-12 col-sm-6 pull-left">
					<div class="form-group">
