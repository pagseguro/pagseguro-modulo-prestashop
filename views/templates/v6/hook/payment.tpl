...
{else}
	<div id="pagbank-container"
		...
		<ul class="nav nav-tabs" tabindex="-1">
			...
			{if $payments.bankslip}
				<li id="boleto-tab" class="nopadding col-xs-12 col-sm-3">
					<a id="toggle-boleto" data-toggle="tab" href="#pagbank-boleto">
			...
			{/if}
			{if $payments.pix}
				<li id="pix-tab" class="nopadding col-xs-12 col-sm-2">
					<a id="toggle-pix" data-toggle="tab" href="#pagbank-pix">
		...
		<div id="pagbankContent" class="tab-content">
			...
			{/if}
			{if $payments.bankslip}
				<div class="tab-pane" id="pagbank-boleto" class="clearfix">
					{include file="$tpl_dir/bankslip.tpl"}
				</div>
			{/if}
			{if $payments.pix}
				<div class="tab-pane" id="pagbank-pix" class="clearfix">
