...
<div id="pagbank-order">
	...
	<div class="panel card panel-info">
		...
		<div class="panel-body card-body nopadding">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<ul class="list list-unstyled">
						...
						{/if}
						<li><b>{l s='Status:' d='Modules.PagBank.Admin'}</b> <span>{$status_pagbank}</span></li>
			...
			<pre class="transaction hidden d-none">{$transaction|print_r}</pre>
			<pre class="info hidden d-none">{$info|print_r}</pre>
		</div>
	</div>
</div>
<script>
