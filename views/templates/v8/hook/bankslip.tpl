...
<div class="container-bankslip clearfix mb-2">
	<div id="pagbank_bankslip_error" class="col-xs-10 col-sm-10 col-lg-9 text-xs-center text-sm-center text-lg-center nofloat-block" style="display:none;"></div>
	<form id="bankslip_pagbank" method="post" action="{$link->getModuleLink('pagbank', 'validation', [], true)|escape:'html'}" 
	class="pagbank_form clearfix" onsubmit="return psBankslipCheckout(event);">
		<input type="hidden" name="payment_type" id="payment_type" value="bankslip"/>
		<input type="hidden" name="recaptcha_bankslip" id="recaptcha_bankslip" />
		<div class="col-xs-12 col-sm-12 col-lg-6 float-xs-left float-sm-left float-left float-start">
			<div class="mb-1">
				...
				<input id="bankslip_name" class="form-control" name="bankslip_name" type="text" data-validate="isName"
					onblur="psValidateBankslip();" size="30"
			...
			<div class="mb-1">
				...
				<input id="bankslip_doc" class="form-control" name="cpf_cnpj" type="text" maxlength="18"
					...
					onblur="psValidateBankslip();" value="" size="18" required />
			</div>
			<div class="mb-1">
				<label class="form-label" for="bankslip_phone">{l s='Telefone de contato:' d='Modules.PagBank.Shop'}</label>
				<input id="bankslip_phone" class="form-control" name="telephone" type="text" inputmode="numeric" pattern="[0-9]*" 
		...
		<div class="right-side col-xs-12 col-sm-12 col-lg-6 float-xs-right float-sm-right float-end">
			...
			{if ($active_discounts.discount_type > 0 && $active_discounts.discount_value > 0) && $active_discounts.bankslip}
				<div class="info-discount alert alert-success text-xs-center text-sm-center text-lg-center">
			...
			{/if}
			<div class="alert alert-info text-xs-center text-sm-center text-lg-center">
				<strong>
		...
		<div class="mb-1 clearfix col-xs-12 col-sm-12 col-lg-12 collapse" id="bankslip_address">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-lg-6 float-xs-left float-sm-left float-left float-start">
					<div class="mb-1">
					...
					<div class="mb-1">
						...
						<input id="bankslip_address_invoice" class="form-control" name="address_invoice" type="text"
							onblur="psValidateBankslip();" autocomplete="off" maxlength="80"
					...
					<div class="mb-1">
						...
						<input id="bankslip_number_invoice" class="form-control" name="number_invoice" type="text"
							onblur="psValidateBankslip();" autocomplete="off" maxlength="10"
				...
				<div class="col-xs-12 col-sm-12 col-lg-6 float-xs-right float-sm-right float-right float-end">
					<div class="mb-1">
						...
						<input id="bankslip_address2_invoice" class="form-control" name="address2_invoice" type="text"
							onblur="psValidateBankslip();" autocomplete="off" maxlength="60"
					...
					<div class="mb-1">
						...
						<select id="bankslip_state_invoice" class="form-select form-control" name="state_invoice"
							data-no-uniform="true" onchange="psValidateBankslip();" required>
							<option value=""> -- </option>
