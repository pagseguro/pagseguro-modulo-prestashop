...
<div class="container-google clearfix mb-2">
	<div id="pagbank_google_error" class="col-xs-10 col-sm-10 col-lg-9 text-xs-center text-sm-center text-lg-center nofloat-block" style="display:none;"></div>
	<form id="google_pagbank" method="post" action="{$link->getModuleLink('pagbank', 'validation', [], true)|escape:'html'}" 
	class="pagbank_form clearfix" onsubmit="return psGoogleCheckout(event);">
		...
		<div class="col-xs-12 col-sm-12 col-lg-6 float-xs-left float-sm-left float-left float-start">
			...
			<p>
				<b>{l s='Clique no botão abaixo para fazer o login e selecionar o seu cartão:' d='Modules.PagBank.Shop'}</b>
			</p>
			...
			{if ($active_discounts.discount_type > 0 && $active_discounts.discount_value > 0) && $active_discounts.google_pay}
				<div class="clearfix">
					<div class="col-xs-12 col-sm-12 col-lg-12 alert alert-success text-xs-center text-sm-center text-lg-center">
		...
		<div class="mb-1 clearfix col-xs-12 col-sm-12 col-lg-12 collapse" id="google_address">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-lg-6 float-xs-left float-sm-left float-left float-start">
					<div class="mb-1">
