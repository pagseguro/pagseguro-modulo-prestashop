...
<div class="container-pix clearfix mb-2">
	<div id="pagbank_pix_error" class="col-xs-10 col-sm-10 col-lg-9 text-xs-center text-sm-center text-lg-center nofloat-block" style="display:none;"></div>
	<form id="pix_pagbank" method="post" action="{$link->getModuleLink('pagbank', 'validation', [], true)|escape:'html'}" 
	class="pagbank_form clearfix" onsubmit="return psPixCheckout(event);">
		...
		<div class="right-side infos col-xs-12 col-sm-12 col-lg-6 float-xs-right float-sm-right float-right float-end">
			...
			{if ($alternate_time != false)}
				<div class="alert alert-warning text-xs-center text-sm-center text-lg-center alternate_time">
		...
		<div class="mb-1 clearfix col-xs-12 col-sm-12 col-lg-12 collapse" id="pix_address">
			<div class="row">	
				<div class="col-xs-12 col-sm-12 col-lg-6 float-xs-left float-sm-left float-left float-start">
					<div class="mb-1">
