...
<div class="container-wallet clearfix mb-2">
	<div id="pagbank_wallet_error" class="col-xs-10 col-sm-10 col-lg-9 text-xs-center text-sm-center text-lg-center nofloat-block" style="display:none;"></div>
	<form id="wallet_pagbank" method="post" action="{$link->getModuleLink('pagbank', 'validation', [], true)|escape:'html'}" 
	class="pagbank_form" onsubmit="return psWalletCheckout(event);">
		...
		<div class="right-side col-xs-12 col-sm-12 col-lg-6 float-xs-right float-sm-right float-right float-end">
		...
		<div class="mb-1 clearfix col-xs-12 col-sm-12 col-lg-12 collapse" id="wallet_address">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-lg-6 float-xs-left float-sm-left float-left float-start">
					<div class="mb-1">
