...
<div class="container-wallet clearfix mt-2 mb-2">
	<form id="wallet_pagbank" name="checkout" method="post" class="clearfix" onsubmit="return ps_walletCheckout(event);">
		...
		<div class="col-xs-12 col-sm-12 clearfix">
			<div class="clearfix">
				<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#ps_wallet_address">
					{l s='Confirmar endereço de cobrança' d='Modules.PagBank.Shop'}
				</button>
			</div>
		</div>
		<fieldset class="col-xs-12 col-sm-12 collapse clearfix address" id="ps_wallet_address">
				...
				<div class="panel-body">
					<div class="col-xs-12 col-sm-6 float-xs-left float-sm-left nopadding">
						<div class="form-group clearfix text-xs-left text-sm-left">
							<label for="ps_wallet_postcode_invoice"
							...
							<div class="input-group col-xs-12 col-sm-12">
								<input class="form-control" type="text" name="ps_postcode_invoice"
									onblur="checkField(this.id);"
									id="ps_wallet_postcode_invoice" autocomplete="off" maxlength="9"
									value="{if isset($address_invoice->postcode)}{$address_invoice->postcode}{/if}"
									required />
							</div>
						</div>
						<div class="form-group clearfix text-xs-left text-sm-left">
							<label for="ps_wallet_address_invoice"
							...
							<div class="input-group col-xs-12 col-sm-12">
								<input class="form-control text-xs-left text-sm-left col-xs-12 col-sm-12" type="text"
									onblur="checkField(this.id);"
									name="ps_address_invoice" id="ps_wallet_address_invoice" autocomplete="off"
									maxlength="80"
						...
						<div class="form-group clearfix text-xs-left text-sm-left">
							<label for="ps_wallet_number_invoice"
							...
							<div class="input-group col-xs-12 col-sm-12">
								<input class="form-control" type="text" name="ps_number_invoice"
									...
									onblur="checkField(this.id);"
									id="ps_wallet_number_invoice" autocomplete="off" maxlength="10"
									value="{if isset($number_invoice)}{$number_invoice}{/if}" required />
							</div>
						</div>
						<div class="form-group clearfix text-xs-left text-sm-left">
							<label for="ps_wallet_other_invoice"
							...
							<div class="input-group col-xs-12 col-sm-12">
								<input class="form-control" type="text" name="ps_other_invoice"
									id="ps_wallet_other_invoice" autocomplete="off" maxlength="40"
					...
					<div class="col-xs-12 col-sm-6 float-xs-left float-sm-left nopadding">
						<div class="form-group clearfix text-xs-left text-sm-left">
							<label for="ps_wallet_address2_invoice"
								class="text-xs-left text-sm-left col-xs-12 col-sm-12">{l s='Bairro:' d='Modules.PagBank.Shop'}</label>
							<div class="input-group col-xs-12 col-sm-12">
								<input class="form-control text-xs-left text-sm-left col-xs-12 col-sm-12" type="text"
									onblur="checkField(this.id);"
									name="ps_address2_invoice" id="ps_wallet_address2_invoice" autocomplete="off"
									maxlength="60"
